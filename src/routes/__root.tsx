  ...
  head: () => ({
    meta: [
      ...
      { title: "Finance Dashboard" },
      {
        name: "description",
        content:
          "A personal finance dashboard to track net worth, spending, and portfolio over time.",
      },
      ...
      { property: "og:image", content: "https://myfinancesss.lovable.app/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://myfinancesss.lovable.app/og-image.png" },
